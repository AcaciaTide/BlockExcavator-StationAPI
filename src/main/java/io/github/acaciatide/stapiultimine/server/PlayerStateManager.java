package io.github.acaciatide.stapiultimine.server;
...
/**
 * サーバーサイドでプレイヤーごとのUltimine状態を管理するシングルトンクラス。
 * プレイヤー名をキーに使用する。
 */
public class PlayerStateManager {

    // プレイヤー名 → Ultimineキー押下状態 のマップ
    ...
    /**
     * プレイヤーのUltimineキーが押されているかを返す。
     * 未登録のプレイヤーはfalseとして扱う。
     */
    public static boolean isUltimineActive(PlayerEntity player) {
